...
- gemini-3.1-flash-image: Fast generation, cost-effective (default)
...
# Model options
MODELS = {
    "flash": "gemini-3.1-flash-image",      # Nano Banana Flash - fast, default
...
def generate_with_nano_banana(prompt_data, output_dir=None, model_key="flash", aspect_ratio="1:1", logo_image=None):
    ...
    Models:
    - flash: gemini-3.1-flash-image (fast, cost-effective) - DEFAULT
...
Models:
  flash (default): gemini-3.1-flash-image - Fast, cost-effective
  pro: gemini-3-pro-image-preview - Quality, 4K text rendering
