...
Models:
- Nano Banana (default): gemini-3.1-flash-image - fast, high-volume, low-latency
...
GEMINI_FLASH = "gemini-3.1-flash-image"  # Nano Banana: fast, high-volume, low-latency
...
def generate_logo(prompt, style=None, industry=None, brand_name=None,
    ...
    model_label = "Nano Banana Pro (gemini-3-pro-image-preview)" if use_pro else "Nano Banana (gemini-3.1-flash-image)"
